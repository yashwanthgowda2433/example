<div id="bodyrow">
   <div class="row-container">
	...
	<div id="formbody"> -->
    <h1>EDIT PRODUCT</h1>
		<form action="<?php echo base_url('welcome/edit/'.$product['product_id']);?>" method="POST" enctype="multipart/form-data">
        <input type="hidden" value="<?php echo $product['product_id'];?>" name="pid"/>
            <div class="row">
                <div class="column">
                    <label>Product Name</label>
                    <input type="text" name="name" class="form-input" value="<?php echo $product['p_name'];?>"required/>
                </div>
            </div>
            <div class="row">
                <div class="column">
                    <label>Product Description</label>
                    <textarea rows="5" name="description" class="form-input" required><?php echo $product['p_description'];?></textarea>
                </div>
            </div>

            <div class="row">
                <div class="column">
                    <img src="<?php echo base_url($product['p_img']);?>" style="width:100px;"/>
                </div>
            </div>
            <div class="row">
                <div class="column">
